...
// The resulting binary can be copied anywhere and run outside the target repo; on first run it clones
// the configured repo into the managed clone location and reviews from that clone.
